...
Source0  : https://files.pythonhosted.org/packages/79/e6/53dc936ddd11353967e5cb7361f537042914745fccfcaa3475505c9ac596/resolvelib-1.1.0.tar.gz
...
%prep
%setup -q -n resolvelib-1.1.0
cd %{_builddir}/resolvelib-1.1.0
pushd ..
cp -a resolvelib-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730388306
