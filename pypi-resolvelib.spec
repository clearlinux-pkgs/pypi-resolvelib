...
Source0  : https://files.pythonhosted.org/packages/05/57/c5c178e21968123cf2aa90501b5fc14a48e342612695863333f4b70510ad/resolvelib-1.2.0.tar.gz
...
%prep
%setup -q -n resolvelib-1.2.0
cd %{_builddir}/resolvelib-1.2.0
pushd ..
cp -a resolvelib-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750960118
